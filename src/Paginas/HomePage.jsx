 ...
 try {
  ...
  <div className='contenedor-carrosuel'>
      ...
      <Accordion.Item eventKey="1">
        <Accordion.Header className='mx-auto'><h2 className='me-auto h2-rock'>Que Ofrecemos?</h2></Accordion.Header>
        <Accordion.Body className='p-rock'>
      ...
      <Accordion.Item eventKey="2">
        <Accordion.Header className='mx-auto'><h2 className='me-auto h2-rock'>Donde nos ubicamos?</h2></Accordion.Header>
        <Accordion.Body className='p-rock'>
      ...
      <Accordion.Item eventKey="3">
        <Accordion.Header className='mx-auto'><h2 className='me-auto h2-rock'>Cual es nuestra mision?</h2></Accordion.Header>
        <Accordion.Body className='p-rock'>
